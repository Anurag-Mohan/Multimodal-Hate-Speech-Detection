...
class MultimodalNet(nn.Module):
    def __init__(self, vocab_size):
        ...
        self.cnn = CustomCNN()
        self.lstm = TextBiLSTMWithAttention(vocab_size, EMBED_DIM, HIDDEN_DIM)
...
def train_model():
    ...
    print(f"--- Starting V4 Training (Attention + Aggressive Aug + OneCycle) ---")
    ...
    torch.save(best_model_wts, 'meme_model_v4.pth')
    import pickle
    with open('vocab_v4.pkl', 'wb') as f:
        pickle.dump(vocab, f)
        
    print(f"\n✅ V4 Complete. Best Validation: {best_val_acc:.2f}%")
